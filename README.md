...
| χ² goodness-of-fit | **10.56** (df=12, p ≈ 0.57) |
...
The polynomial Q₄₇(n) = n⁴⁷ − (n−1)⁴⁷ has degree 46 and possesses a remarkable **algebraic shield**: for any prime p ≢ 1 (mod 47), we have ω(p) = 0, meaning ~97.8% of all primes cannot divide any value of Q₄₇. This results in an unusually large Bateman–Horn structural constant (C_BH ≈ 6514, compared to ~1.32 for twin primes).
